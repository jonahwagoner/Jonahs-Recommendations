...
const ORDINARY_LACTIC= {
    brand: "Lactic Acid: An alpha hydroxyl acid that exfoliates the skin.",
...
const VERSED_BRIGHTENING= {
    ...
    ingredients:"<p>Vitamin C: Rich in antioxidants, it shields the skin from free radicals.</p><p>Licorice Root Extract: Targets hyperpigmentation, dark spots and sun damage.</p>",
    image: '/some/path',
    type: "Treatment",
    concern: "Dullness"
};
